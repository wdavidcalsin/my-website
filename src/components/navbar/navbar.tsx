...
import { Box, Collapse, Link as ChakraLink, ScaleFade, useColorMode } from '@chakra-ui/react';
...
const Navbar = () => {
    ...
    const { isTransition, setIsTransitionTrue } = useStoreShowNavbar((state) => state);
    ...
    return (
        <Box pointerEvents={'none'} position="fixed" top={'6'} zIndex="30" width={'full'}>
            <MainContainer>
                <ScaleFade
                    initialScale={0.7}
                    in={isShowNav}
                ...
                >
                    ...
                    >
                        ...
                        <Box display={'flex'} alignItems="center" gap={'1rem'}>
                            <Box display={'flex'} gap="1rem" fontWeight={'extrabold'} fontSize="1.1rem">
