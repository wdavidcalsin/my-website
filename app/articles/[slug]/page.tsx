...
export default async function Page({ params }: { params: { slug: string } }) {
    ...
    const components = {
        ...
        h2: (props: any) => (
            <h2
                {...props}
                className="text-lg  text-zinc-200 mt-16 font-semibold"
            />
        ),
        h3: (props: any) => (
        ...
        p: (props: any) => (
            <p {...props} className="text-base my-4 text-zinc-400 leading-9" />
        ),
        a: (props: any) => (
            <a
                {...props}
        ...
        li: (props: any) => (
            <li {...props} className="text-base text-zinc-400 my-2" />
        ),
        ...
        <div className="relative">
            ...
            <article className="prose dark:prose-invert prose-xl mx-auto">
                <div className="flex flex-col gap-6 sm:gap-8 mb-12">
                    ...
                    <div className="relative border border-zinc-800 italic font-normal text-zinc-400 rounded-sm py-3 px-3">
                        <span className="absolute top-0 left-3 transform  -translate-y-1/2 bg-teal-700  text-zinc-100 font-semibold border border-teal-400 rounded-sm px-1 py-0 text-xs">
                            Description
                        </span>
                        <p className="py-0 m-0 text-base">
